...
Purpose: The purpose of this application is to add customers and schedule appointments for them for purposes of
    keeping business organized. The customers and appointments can also be modified.
Author: Justin Rinehuls
Contact email: jrinehu@wgu.edu
...
Directions for how to run the program: Run the program in the IDE to launch the application. Log in using a correct
    ...
    to close it.
        In the customers pane, click the Add Customer button. This takes you to the Add Customer Form. Fill out all
    ...
    on that to close it. If you decide not to delete during the first pop-up, click cancel.
        In the appointments pane, click the Add Appointment button. This takes you to the Add Appointment Form. Fill out
    ...
    the first pop-up, click cancel.
        Below the appointments pane there are 3 radio buttons. All appointments is selected by default and shows all
    appointments. If you select this month's appointments, only appointments for the current month are shown. If you
    select this week's appointments, only appointments for the current week are shown.
        There is also a Reports button. Click on that to go to the Reports Screen. Here there are 3 reports to view.
